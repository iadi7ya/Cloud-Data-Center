...
if user:
  ...
  print "<p><center>Click on the Download Link to download the script.</center><br/><center>Execute the Script to mount your drive's snapshot!!!</center> </p><br/><br/><center>"
  print "<center><a href='http://192.168.0.100/scripts/mountobjsnap_"+user+".py'>Download Script</a></center><br/><br/>"
